...
public class Adresboek {
	...
	public String toString(){
		StringBuilder stringBuilder = new StringBuilder("Aantal contacten: " + this.contacten.size() + "\n");
		Iterator value = this.contacten.iterator();

		while (value.hasNext())
			stringBuilder.append(value.next().toString() + "\n");
