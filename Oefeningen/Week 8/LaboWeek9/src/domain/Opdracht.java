...
public class Opdracht {
     ...
     *
     * @param id                  de id voor deze opdracht (moet uit de opdrachten db komen)
     * @param vraag               de vraag voor deze opdracht
     * @param antwoord            het 1-woord-of-getal antwoord
     * @param hoofdlettergevoelig geeft aan of bij het antwoord rekening gehouden moet worden
     *                            met hoofdletters
     * @param hint                de antwoord-hint
     * @param categorie           een van de vijf bovenaan gedefinieerde categorieen
     * @param auteur              de naam van de bedenker van deze opdracht
     */
     ...
     * @param hoofdlettergevoelig geeft aan of bij het antwoord rekening gehouden moet worden
     *                            met hoofdletters
     * @param categorie           categorie een van de vijf bovenaan gedefinieerde categorieen
     * @param auteur              de naam van de bedenker van deze opdracht
     */
    public Opdracht(int id, String vraag, String antwoord,
    ...
    /**
     * @param opdrachtID the opdrachtID to set
     */
    ...
    /**
     * @param vraag de nieuwe waarde voor vraag
     */
    ...
    /**
     * @param antwoord de nieuwe waarde voor antwoord
     */
    ...
    /**
     * @param isHoofdletterGevoelig de nieuwe waarde voor isHoofdletterGevoelig
     */
    ...
    /**
     * @param antwoordHint de nieuwe waarde voor antwoordHint
     */
    ...
    /**
     * @param categorie de nieuwe waarde voor categorie
     */
    ...
    /**
     * @param auteur de nieuwe waarde voor auteur
     */
    ...
    public boolean equals(Object o) {
        ...
        return opdrachtID == opdracht.opdrachtID && isHoofdletterGevoelig == opdracht.isHoofdletterGevoelig
                && Objects.equals(vraag, opdracht.vraag) && Objects.equals(antwoord, opdracht.antwoord)
                && Objects.equals(antwoordHint, opdracht.antwoordHint) && Objects.equals(categorie, opdracht.categorie)
